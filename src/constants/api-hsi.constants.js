...
export const HSI_GET_MEDICAL_COVERAGE = `${baseUrlHSI}/appointment/booking/medicalCoverges`;

export const HSI_GET_AVAILABLE_APPOINTMENTS = (institution_id, specialty_id, coverage_id) => {
    return `${baseUrlHSI}/institution/${institution_id}/appointment/booking/specialty/${specialty_id}/practice/1/medicalCoverages/${coverage_id}/availability`;
};
